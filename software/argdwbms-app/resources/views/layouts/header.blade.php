<header class="main-header mb-5">
    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top pl-30" style="margin-left: 0;">
        ...
        <div>
            <ul class="nav">
                ...
                <li class="btn-group nav-item d-none d-xl-inline-block">
                    <a href="{{ route('dashboard') }}" class="waves-effect waves-light nav-link rounded svg-bt-icon"
                        title="">
                        <i class="ti-home"></i>
                    </a>
                </li>
                <li class="btn-group nav-item d-none d-xl-inline-block">
                    <a href="{{ route('calendar') }}" class="waves-effect waves-light nav-link rounded svg-bt-icon"
                        title="">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0"
                        ...
                        <img class="rounded-circle header-profile-user"
                            src="{{ Avatar::create(auth()->user()->name)->toBase64() }}" alt="Header Avatar">
                    </a>
